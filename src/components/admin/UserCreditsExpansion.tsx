...
interface UserCreditsExpansionProps {
  userId: number
  customerId: number | null
  onRefresh?: () => void
}

export default function UserCreditsExpansion({ userId, customerId, onRefresh }: UserCreditsExpansionProps) {
        ...
        <div>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
            <h4 style={{ margin: 0, fontSize: 14, color: '#374151', fontWeight: 400 }}>
              <CreditCard size={16} style={{ display: 'inline-block', marginRight: '8px', verticalAlign: 'middle' }} />
              Danh sách Service Credits ({credits.length})
            </h4>
          </div>
